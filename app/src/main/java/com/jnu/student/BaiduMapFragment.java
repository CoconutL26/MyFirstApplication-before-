...
import com.jnu.student.data.LibraryLocation;
...
public class BaiduMapFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                List<LibraryLocation> locations=dataLoader.ParseJsonData(shopJsonData);
    ...
    private void AddMarkersOnMap(List<LibraryLocation> locations) {
        BitmapDescriptor bitmap= BitmapDescriptorFactory.fromResource(R.drawable.home);
        for (LibraryLocation shop: locations) {
